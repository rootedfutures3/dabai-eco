...
/* ============================================================
   ...
   ============================================================ */
const TREE_ROWS = [
  ['DB-000001','dabai','在地原生種',34,'Rumah Panjai 上游果園','Sibu','Ak. Jelani 一家',85,420,'available'],
  ['DB-000002','dabai','在地原生種',34,'Rumah Panjai 上游果園','Sibu','Ak. Jelani 一家',78,400,'adopted'],
  ['DB-000003','dabai','在地原生種',31,'Rumah Panjai 上游果園','Sibu','Ak. Jelani 一家',72,390,'available'],
  ['DB-000004','dabai','在地原生種',18,'Nanga Sepit 河谷果園','Kapit','Lim 氏果園（第二代）',64,350,'available'],
  ['DB-000005','dabai','在地原生種',18,'Nanga Sepit 河谷果園','Kapit','Lim 氏果園（第二代）',61,350,'available'],
  ['DB-000006','dabai','在地原生種',17,'Nanga Sepit 河谷果園','Kapit','Lim 氏果園（第二代）',58,340,'reserved'],
  ['DB-000007','dabai','在地原生種',41,'Sarikei 老欉園','Sarikei','Tan 老先生',92,460,'available'],
  ['DB-000008','dabai','在地原生種',41,'Sarikei 老欉園','Sarikei','Tan 老先生',88,450,'adopted'],
  ['DB-000009','dabai','在地原生種',27,'Song 支流果園','Song','Empaling 一家',70,380,'available'],
  ['DB-000010','dabai','在地原生種',27,'Song 支流果園','Song','Empaling 一家',66,370,'available'],
  ['DB-000011','dabai','在地原生種',38,'Kapit 高地老欉','Kapit','Bujang 老欉園',80,440,'available'],
  ['DB-000012','dabai','在地原生種',9,'Serian 混作果園','Serian','Anak Bunsu',32,260,'available'],
  ['DB-000013','dabai','在地原生種',9,'Serian 混作果園','Serian','Anak Bunsu',30,260,'available'],
  ['DB-000014','dabai','在地原生種',31,'Meradong 家族果園','Meradong','Rumah Belaja 長屋',75,410,'adopted'],
  /* 補到 30 棵 —— 對齊「第 1 年試點 30 棵」的規劃，
     讓網站上看到的規模和簡報講的一致。全部是示範資料。 */
  ['DB-000015','dabai','在地原生種',29,'Rumah Panjai 上游果園','Sibu','Ak. Jelani 一家',68,380,'available'],
  ['DB-000016','dabai','在地原生種',22,'Rumah Panjai 上游果園','Sibu','Ak. Jelani 一家',59,340,'available'],
  ['DB-000017','dabai','在地原生種',15,'Nanga Sepit 河谷果園','Kapit','Lim 氏果園（第二代）',52,320,'available'],
  ['DB-000018','dabai','在地原生種',15,'Nanga Sepit 河谷果園','Kapit','Lim 氏果園（第二代）',50,320,'reserved'],
  ['DB-000019','dabai','在地原生種',36,'Sarikei 老欉園','Sarikei','Tan 老先生',86,450,'available'],
  ['DB-000020','dabai','在地原生種',36,'Sarikei 老欉園','Sarikei','Tan 老先生',83,440,'available'],
  ['DB-000021','dabai','在地原生種',24,'Song 支流果園','Song','Empaling 一家',63,360,'adopted'],
  ['DB-000022','dabai','在地原生種',24,'Song 支流果園','Song','Empaling 一家',61,360,'available'],
  ['DB-000023','dabai','在地原生種',19,'Song 支流果園','Song','Empaling 一家',55,330,'available'],
  ['DB-000024','dabai','在地原生種',44,'Kapit 高地老欉','Kapit','Bujang 老欉園',95,470,'available'],
  ['DB-000025','dabai','在地原生種',44,'Kapit 高地老欉','Kapit','Bujang 老欉園',90,460,'reserved'],
  ['DB-000026','dabai','在地原生種',11,'Serian 混作果園','Serian','Anak Bunsu',38,280,'available'],
  ['DB-000027','dabai','在地原生種',11,'Serian 混作果園','Serian','Anak Bunsu',36,280,'available'],
  ['DB-000028','dabai','在地原生種',28,'Meradong 家族果園','Meradong','Rumah Belaja 長屋',71,390,'available'],
  ['DB-000029','dabai','在地原生種',28,'Meradong 家族果園','Meradong','Rumah Belaja 長屋',69,390,'available'],
  ['DB-000030','dabai','在地原生種',21,'Meradong 家族果園','Meradong','Rumah Belaja 長屋',58,340,'available'],

  ['DR-000001','durian','貓山王 Musang King',12,'Kanowit 坡地果園','Kanowit','Nyawai 家族',48,1200,'available'],
  ['DR-000002','durian','貓山王 Musang King',12,'Kanowit 坡地果園','Kanowit','Nyawai 家族',45,1180,'adopted'],
  ['DR-000003','durian','貓山王 Musang King',11,'Kanowit 坡地果園','Kanowit','Nyawai 家族',42,1150,'available'],
  ['DR-000004','durian','D24',22,'Betong 平原果園','Betong','Rumah Ugap 合作社',66,820,'available'],
  ['DR-000005','durian','D24',22,'Betong 平原果園','Betong','Rumah Ugap 合作社',63,810,'available'],
  ['DR-000006','durian','D24',21,'Betong 平原果園','Betong','Rumah Ugap 合作社',60,800,'reserved'],
  ['DR-000007','durian','紅蝦 Udang Merah',16,'Julau 山腰果園','Julau','Chan 氏兄弟',38,760,'available'],
  ['DR-000008','durian','紅蝦 Udang Merah',16,'Julau 山腰果園','Julau','Chan 氏兄弟',35,750,'available'],
  ['DR-000009','durian','黑刺 Black Thorn',14,'Bintulu 沿海果園','Bintulu','Ngu 家果園',40,980,'available'],
  ['DR-000010','durian','黑刺 Black Thorn',14,'Bintulu 沿海果園','Bintulu','Ngu 家果園',37,960,'adopted'],
  ['DR-000011','durian','D101',7,'Sibu 近郊示範園','Sibu','平台示範園（契作）',22,600,'available'],
  ['DR-000012','durian','D101',7,'Sibu 近郊示範園','Sibu','平台示範園（契作）',20,600,'available'],

  ['RB-000001','rambutan','R156 黃金紅毛丹',15,'Serian 混作果園','Serian','Anak Bunsu',110,240,'available'],
  ['RB-000002','rambutan','R156 黃金紅毛丹',15,'Serian 混作果園','Serian','Anak Bunsu',105,240,'available'],
  ['RB-000003','rambutan','R156 黃金紅毛丹',14,'Serian 混作果園','Serian','Anak Bunsu',98,230,'adopted'],
  ['RB-000004','rambutan','R191 甜紅毛丹',19,'Sarikei 老欉園','Sarikei','Tan 老先生',125,260,'available'],
  ['RB-000005','rambutan','R191 甜紅毛丹',19,'Sarikei 老欉園','Sarikei','Tan 老先生',120,260,'available'],
  ['RB-000006','rambutan','R191 甜紅毛丹',18,'Sarikei 老欉園','Sarikei','Tan 老先生',115,250,'reserved'],
  ['RB-000007','rambutan','在地原生種',26,'Song 支流果園','Song','Empaling 一家',140,270,'available'],
  ['RB-000008','rambutan','在地原生種',26,'Song 支流果園','Song','Empaling 一家',132,270,'available'],
  ['RB-000009','rambutan','在地原生種',8,'Sibu 近郊示範園','Sibu','平台示範園（契作）',55,190,'available'],
  ['RB-000010','rambutan','在地原生種',8,'Sibu 近郊示範園','Sibu','平台示範園（契作）',52,190,'available'],
];
